<?php
    ...
    imageline($image, $x4, $square_xy_1 / 2, $size / 2, $square_xy_1, $black);
    imageline($image, $square_xy_2, $size / 2, $square_xy_2 + $square_xy_1 / 2, $size / 2, $black);
    imageline($image, $x4, $square_xy_2, $size / 2, $square_xy_2 + $square_xy_1 / 2, $black);
    imageline($image, $square_xy_1 / 2, $size / 2, $square_xy_1, $size / 2, $black);

    imagearc($image, $x4, $y4, $size - $square_xy_1, $size - $square_xy_1, 260, 280, $black);
    imagearc($image, $x4, $y4, $size - $square_xy_1, $size - $square_xy_1, 350, 10, $black);
    imagearc($image, $x4, $y4, $size - $square_xy_1, $size - $square_xy_1, 80, 100, $black);
    imagearc($image, $x4, $y4, $size - $square_xy_1, $size - $square_xy_1, 170, 190, $black);

    imagefilledellipse($image, $size / 4, $size / 4, $size / 100, $size / 100, $black);
    imagefilledellipse($image, $x4, $size / 4, $size / 100, $size / 100, $black);
    imagefilledellipse($image, $size - $size / 4, $size / 4, $size / 100, $size / 100, $black);
    imagefilledellipse($image, $size / 4, $y4, $size / 100, $size / 100, $black);
    imagefilledellipse($image, $x4, $y4, $size / 100, $size / 100, $black);
    imagefilledellipse($image, $size - $size / 4, $y4, $size / 100, $size / 100, $black);
    imagefilledellipse($image, $size / 4, $size - $size / 4, $size / 100, $size / 100, $black);
    imagefilledellipse($image, $x4, $size - $size / 4, $size / 100, $size / 100, $black);
